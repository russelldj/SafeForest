...
from config import RUI_CLASSES, RUI_PALETTE, YAMAHA_CLASSES, YAMAHA_PALETTE, RUI_YAMAHA_CLASSES, RUI_YAMAHA_PALETTE
...
show_label_colors(YAMAHA_CLASSES, YAMAHA_PALETTE, "Yamaha labelmaps", "vis/yamaha_labelmap.png")
show_label_colors(RUI_YAMAHA_CLASSES, RUI_YAMAHA_PALETTE, "Rui-Yamaha merged labelmaps", "vis/rui_yamaha_labelmap.png")
